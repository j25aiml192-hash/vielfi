...
const REPUTATION_TIMELINE = [
  { date: 'Mar 2024', event: 'SBT Minted', marker: 'SBT', color: 'text-gold' },
  { date: 'Mar 2024', event: 'ZK Proof Generated', marker: 'ZK', color: 'text-indigo' },
  { date: 'Mar 2024', event: 'GST Data Linked', marker: 'GST', color: 'text-teal' },
  { date: 'Feb 2024', event: 'UPI History Verified', marker: 'UPI', color: 'text-teal' },
  { date: 'Jan 2024', event: 'Loan #1 Repaid Early', marker: 'OK', color: 'text-teal' },
  { date: 'Jul 2023', event: 'Loan #2 Funded', marker: 'INR', color: 'text-gold' },
]
          ...
          <div className="flex flex-col sm:items-end gap-3">
            {!isConnected && (
              <div className="card border border-gold/30 bg-gold/5 text-sm text-gold py-3 px-4 max-w-xs">
                Showing Rahul demo profile. Connect wallet for your live address.
              </div>
            )}
            <a
              href={ETHERSCAN_URL}
