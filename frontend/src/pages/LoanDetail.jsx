          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 text-sm text-secondary">
                <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}><Calendar size={13} /> {loan.daysLeft} days remaining</span>
                <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}><Users size={13} /> {loan.lenders} lenders</span>
                <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}><TrendingUp size={13} /> {loan.interestRate}% APR</span>
                <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}><Clock size={13} /> {loan.duration} months</span>
              </div>
            </div>
          ...
          <div className="space-y-5">
            ...
            {success ? (
              <div className="card border border-semantic-success/40 bg-semantic-success/5 text-center py-8">
                <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 12 }}><Sparkles size={40} color="#D4AF37" /></div>
