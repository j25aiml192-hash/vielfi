...
import { Sparkles, Circle as CircleIcon } from 'lucide-react'
          ...
          <div className="animate-fade-in">
            {joined.length === 0 ? (
              <div className="text-center py-20">
                <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 16 }}><CircleIcon size={64} color="#D1D5DB" /></div>
